...
struct E1000 {
  ...
  volatile uint32_t EERD;             /* 0x00014  EERD - RW for challenge */
  ...
  uint32_t reserved11;
  volatile uint32_t TDT;              /* 0x03818  TX Descriptor Tail - RW */
...
extern char e1000_macaddr[MACADDR_SIZE];
